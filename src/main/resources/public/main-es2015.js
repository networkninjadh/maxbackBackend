...
/* harmony import */ var _services_cusomter_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/cusomter.service */ "w1xC");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/forms */ "3Pt+");
/* harmony import */ var _messages_messageboard_messageboard_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../messages/messageboard/messageboard.component */ "uvVQ");
...
class ProfileComponent {
    ...
    onSubmit() {
        ...
        this.http.post("http://localhost:8080/files/customer-profile/profile-image/" + this.customer.customerId, formData, { headers: { Authorization: `Bearer ${localStorage.getItem('bearer_token')}` } }).subscribe((res) => {
...
ProfileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProfileComponent, selectors: [["app-profile"]], decls: 74, vars: 6, consts: [[1, "container"], [1, "main-body"], [1, "row", "gutters-sm"], [1, "col-md-4", "mb-3"], [1, "card"], [1, "card-body"], [1, "d-flex", "flex-column", "align-items-center", "text-center"], ["alt", "Admin", "width", "150", 1, "rounded-circle", 3, "src"], [3, "formGroup", "ngSubmit"], ["type", "file", "name", "profile", 3, "change"], ["type", "submit"], [1, "mt-3"], [1, "text-secondary", "mb-1"], [1, "btn", "btn-primary"], [1, "btn", "btn-outline-primary"], [1, "col-md-8"], [1, "card", "mb-3"], [1, "row"], [1, "col-sm-3"], [1, "mb-0"], [1, "col-sm-9", "text-secondary"], [1, "col-sm-6", "mb-3"], [1, "card", "h-100"], ["id", "videos"], ["id", "subscriber"], ["id", "publisher"]], template: function ProfileComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "div", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](2, "div", 2);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](3, "div", 3);
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ProfileComponent, [{
    ...
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }, { type: _services_cusomter_service__WEBPACK_IMPORTED_MODULE_3__["CustomerService"] }, { type: _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormBuilder"] }]; }, null); })();
...
class CustomerService {
    ...
    getCustomer() {
        debugger;
        return this.http.get("http://localhost:8080/profile-api/customer/", { headers: { Authorization: `Bearer ${localStorage.getItem("bearer_token")}` } });
        debugger;
    }
}
