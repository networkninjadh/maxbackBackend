...
class AuthenticationService {
    ...
    register(username, role, password, email, address, phone) {
        ...
        return this.http.post(`${_CONSTANTS__WEBPACK_IMPORTED_MODULE_1__["CONSTANTS"].PRODUCTION_BASE_URL}${_CONSTANTS__WEBPACK_IMPORTED_MODULE_1__["CONSTANTS"].REGISTER}`, payload).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])((data) => {
            ...
            if (role === 'CUSTOMER') {
                ...
                return this.http.post(`${_CONSTANTS__WEBPACK_IMPORTED_MODULE_1__["CONSTANTS"].PRODUCTION_BASE_URL}/profile-api/customer/new`, payload2, data.token).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["shareReplay"])());
            }
            else {
                return;
            }
    ...
    signIn(username, role, password) {
        ...
        return this.http.post(`${_CONSTANTS__WEBPACK_IMPORTED_MODULE_1__["CONSTANTS"].PRODUCTION_BASE_URL}${_CONSTANTS__WEBPACK_IMPORTED_MODULE_1__["CONSTANTS"].LOG_IN}`, payload).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["shareReplay"])());
    }
    logOut() {
