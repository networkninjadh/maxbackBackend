      ...
      var AuthenticationService = /*#__PURE__*/function () {
        ...
        _createClass(AuthenticationService, [{
          ...
          value: function register(username, role, password, email, address, phone) {
            ...
            return this.http.post("".concat(_CONSTANTS__WEBPACK_IMPORTED_MODULE_1__["CONSTANTS"].PRODUCTION_BASE_URL).concat(_CONSTANTS__WEBPACK_IMPORTED_MODULE_1__["CONSTANTS"].REGISTER), payload).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["tap"])(function (data) {
              ...
              if (role === 'CUSTOMER') {
                ...
                return _this5.http.post("".concat(_CONSTANTS__WEBPACK_IMPORTED_MODULE_1__["CONSTANTS"].PRODUCTION_BASE_URL, "/profile-api/customer/new"), payload2, data.token).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["shareReplay"])());
              } else {
                return;
              }
            }));
          ...
          value: function signIn(username, role, password) {
            ...
            return this.http.post("".concat(_CONSTANTS__WEBPACK_IMPORTED_MODULE_1__["CONSTANTS"].PRODUCTION_BASE_URL).concat(_CONSTANTS__WEBPACK_IMPORTED_MODULE_1__["CONSTANTS"].LOG_IN), payload).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["shareReplay"])());
          }
        }, {
          key: "logOut",
